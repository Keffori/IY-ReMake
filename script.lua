...
Title.TextSize = 18
Title.Text = "Infinite Yield Re-Make v"..ver
...
reference = (function()
	...
	inviteButton.MouseButton1Click:Connect(function()
		...
		if func then
			func("https://discord.gg/dgxS9ZDDd5")
		...
		inviteButton.Text = "Copy Discord Invite Link (https://discord.gg/dgxS9ZDDd5)"
	end)
	dragGUI(main)
	main.Parent = PARENT
...
CMDs[#CMDs + 1] = {NAME = 'gotomodel [part name]', DESC = 'Moves your character to a model or multiple models (you found last secret)'}
...
addcmd('discord', {'support', 'help'}, function(args, speaker)
	if toClipboard then
		toClipboard('https://discord.gg/dgxS9ZDDd5')
		notify('Discord Invite', 'Copied to clipboard!\nhttps://discord.gg/dgxS9ZDDd5')
	else
		notify('Discord Invite', 'https://discord.gg/dgxS9ZDDd5')
	end
	if httprequest then
		httprequest({
